...
<div class="small-container">
    <div class="form">
        <div class="formnt z-depth-2">
            <h5 class="center-align"><spring:message code="session.passwordResetSuccess"/></h5>

            <p class="center-align"><spring:message code="session.passwordResetSuccessInstructions"/></p>
