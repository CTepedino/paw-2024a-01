...
public class QuestionJpaDaoTest {
    ...
    public void testGetAllFromUserAndBook(){
        List<Question> questions = questionDao.getAll((long)101, null, (long)101, false, null, 0, 999);
    ...
    public void testGetAllFromWriter(){
        ...
        List<Question> questions = questionDao.getAll(null, (long) 101, null,  false, null,0, 999);
    ...
    public void testGetAllFullQuestionsNotUser(){
        ...
        List<Question> questions = questionDao.getAll(null, null, (long)102, true, true, 0, 999);
