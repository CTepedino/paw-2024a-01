...
public class OrderJpaDaoTest{
    ...
    public void testCreateOK(){
        Order order = orderDao.create(TEST_USER, TEST_BOOK, OrderStatus.WAITING_APPROVAL, LocalDateTime.now(), TEST_BOOK.getPrice());
    ...
    public void testSetStatusExistingOrder(){
        ...
        orderDao.update(order, OrderStatus.WAITING_APPROVAL, LocalDateTime.now());
    ...
    public void testAllReaderOrders(){
        ...
        List<Order> orders = orderDao.getAllOrders(null, null, (long)1, "", null, 0, 999);
    ...
    public void testGetWriterOrders(){
        List<Order> orders = orderDao.getAllOrders(null, (long)2, null, "", null, 0, 999);
    ...
    public void testGetWriterOrdersWithParams(){
        List<Order> orders = orderDao.getAllOrders(null, (long)2, null,"my book", OrderStatus.WAITING_APPROVAL, 0, 999);
