...
public class ReviewJpaDaoTest {
    ...
    public void testGetAverageRating(){
        em.createNativeQuery("INSERT INTO reviews (review_id, reviewer_id, book_id, rating, review) VALUES (102,101, 102, 2, ''), (103,102, 102, 10, '')").executeUpdate();

        int avg = reviewDao.getAverageRating(102);
    ...
    public void testGetAverageRatingNoReviews(){
        ...
        int avg = reviewDao.getAverageRating(101);
